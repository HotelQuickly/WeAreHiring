...
**We are looking for a Node.js developer who wants to help us to create an outstanding product.**
...
* watching trends and best practices in Node.js development
...
* some Node.js framework (we use [Hapi](https://github.com/spumko/hapi))
...
* templating system (we use [Swig](http://paularmstrong.github.io/swig/))
