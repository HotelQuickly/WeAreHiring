...
You want to be a part of a team creating a world-class product and creatively contribute to ongoing development.
...
Do you feel like helping us with building this product?

### The job and the challenges

We expect you to take ownership of the front-end projects, especially marketing-related ones. You should be

* watching trends and best practices in front-end development (new CSS hacks, Javascript plugins etc.)
* reading blogs and compiling ideas how to improve our Frontend
...
* able to quicky implement new things requested by marketing
* able to work in a team with other developers (you'll need APIs from Backend team)
...
You can be working in our office in Bangkok, directly with all the other engineers and the tech co-founder. We have a beautiful office here full of snacks and Coke. 27" screens and ergonomic chairs.

But you can also *work remotely* if you prefer. Our marketing team is distributed across Asia-Pacific.
...
<a href="httphttp://hotelquickly.theresumator.com/apply/6MELQA/Frontend-Developer.html?source=wearehiring">
