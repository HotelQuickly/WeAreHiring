...
You have 5-10 years of experience - not just SW development, but also designing scalable systems.

We don't really care about your level of formal education, math skill, and so on. We want to see that you know the shit.

As we grow, we face lots of new challenges. We expect *you've been there, done that* and will be able to advise.
...
You can also work from home as much as you prefer. 
...
* **Equity** - We also offer stock options. Yay!

In addition we offer much more to make you happy - check the [compensation packages](https://github.com/HotelQuickly/WeAreHiring/blob/master/README.md#compensation--perks).
...
Do you want to enjoy some fun while working with us? Then send an email to michal.juhas@hotelquickly.com. 
